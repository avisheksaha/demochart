  ...
  <div class="container-fluid mb-2">
          ...
          <div class="col-md-6" style="padding-right:0px !important;">
            <div class="card bg-dark">
              ...
              >
                ...
                <h2 v-if="this.xyz.Grower_count > 0" class="mt-3">{{this.xyz.Grower_count}}</h2>
                <h2 class="mt-3" v-else>{{this.xyzState.Grower_count}}</h2>
          ...
          <div class="col-md-6" style="padding-left:5px !important;">
            <div class="card bg-dark">
              ...
              >
                ...
                <h2 class="mt-3" v-else>{{this.xyzState.total_plantation}}</h2>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="row" style="padding-top:4px;">
      <div class="col-md-3" style="padding-right:0px !important;">
        <div class="card bg-dark px-4" style="height:230px;">
      ...
      <div class="col-md-3" style="padding-right:0px !important; padding-left:5px !important;">
        <div class="card px-4 bg-dark" style="height:230px;">
          <doughnutcaste-chart
      ...
      <div class="col-md-6" style="padding-right:0px !important; padding-left:5px !important;">
        <div class="row">
          <div class="col-md-6">
            <div class="card" style="230px;">
              <div class="card-body text-white">
                <h6>Total factories</h6>
                <h2 v-if="this.factoryCtg.total > 0" class="mt-3">{{ this.factoryCtg.total }}</h2>
                <h2 class="mt-3" v-else>{{ this.factoryCtgState.total }}</h2>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="card bg-dark px-4 pb-2" style="230px;">
